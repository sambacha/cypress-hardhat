...
import type { AllowanceTransfer, AllowanceTransferInterface } from "../AllowanceTransfer";
export declare class AllowanceTransfer__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): AllowanceTransfer;
}
